...
(function($) {
    ...
    var blog = {
		...
		Food_Health: function(){
			...
			$('.blog_magagine .tab-pane').css("display","none");
			$('#nav-tab8 a').on('click', function(e){
				$('.blog_magagine .custom_tab_content .tab').css('display' , 'none');
				var t = $(this).attr('href');
				$('.blog_magagine .tab-pane').hide();
				$(t).show();
				//return false;

			});
			$('.blog_magagine .tab-pane.active.show').show();
						
			$('.blog_magagine .tabs.animated-fade .tab-links .link_data a').on('click', function(e)  {
				$('.blog_magagine .tab-content .tab-pane').css('display' , 'none');
			});



			$('.my-photoss .tab-pane').css("display","none");
			$('#nav-tab9 a').on('click', function(e){
				$('.my-photoss .custom_tab_content .tab').css('display' , 'none');
				var t = $(this).attr('href');
				$('.my-photoss .tab-pane').hide();
				$(t).show();
				//return false;

			});
			$('.my-photoss .tab-pane.active.show').show();
						
			$('.my-photoss .tabs.animated-fade .tab-links .link_data a').on('click', function(e)  {
				$('.my-photoss .tab-content .tab-pane').css('display' , 'none');
			});


			
			$('.blog-technoo .tab-pane').css("display","none");
			$('#nav-tab10 a').on('click', function(e){
				$('.blog-technoo .custom_tab_content .tab').css('display' , 'none');
				var t = $(this).attr('href');
				$('.blog-technoo .tab-pane').hide();
				$(t).show();
				//return false;

			});
			$('.blog-technoo .tab-pane.active.show').show();
						
			$('.blog-technoo .tabs.animated-fade .tab-links .link_data a').on('click', function(e)  {
				$('.blog-technoo .tab-content .tab-pane').css('display' , 'none');
			});


			
			$('.blog-article .tab-pane').css("display","none");
			$('#nav-tab12 a').on('click', function(e){
				$('.blog-article .custom_tab_content .tab').css('display' , 'none');
				var t = $(this).attr('href');
			...
			$('.blog-article .tab-pane.active.show').show();
						
			$('.blog-article .tabs.animated-fade .tab-links .link_data a').on('click', function(e)  {
				$('.blog-article .tab-content .tab-pane').css('display' , 'none');
			});
